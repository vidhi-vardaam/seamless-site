    ...
    <div class="container" style="position: relative; z-index: 10;">
        <div style="max-width: 64rem; margin: 0 auto; text-align: center;">
            <div class="scroll-animate">
                <h1 class="font-display" style="font-size: clamp(3rem, 6vw, 4.5rem); color: white; margin-bottom: 1.5rem; line-height: 1.1; letter-spacing: -0.02em;">
            ...
            <div class="scroll-animate animate-delay-200">
                <div style="display: flex; flex-direction: column; gap: 1rem; justify-content: center; align-items: center; margin-top: 2rem;">
...
<section id="pillars-section" style="padding: 7rem 0; position: relative; overflow: hidden; background-size: cover; background-position: center; background-repeat: no-repeat; background-image: url('{{ asset('assets/section-6-bg.png') }}')">
    <div class="container" style="position: relative;">
                    ...
                    <div class="pillar-card">
                        <div class="pillar-card-content">
                            ...
                            <div style="position: relative;">
                                ...
                                <h3 class="font-display" style="font-size: 1.875rem; color: hsl(var(--foreground)); margin-bottom: 0.75rem;">
                                    {{ $pillar['title'] }}
                                </h3>
                ...
                <div class="scroll-animate" style="transition-delay: {{ $capability['delay'] }}ms;">
                    <div class="capability-card">
                        <div style="display: flex; align-items: flex-start; gap: 1.25rem;">
                            ...
                            <div style="flex: 1;">
                                <h3 class="font-display" style="font-size: 1.25rem; color: hsl(var(--foreground)); margin-bottom: 0.5rem;">
                                    {{ $capability['title'] }}
                                </h3>
                                <p style="color: hsl(var(--foreground) / 0.7); font-size: 0.875rem; margin-bottom: 1rem;">
                                    {{ $capability['impact'] }}
                                </p>
                                ...
                                <ul style="display: flex; flex-direction: column; gap: 0.625rem;">
                                    ...
                                    <li style="display: flex; align-items: flex-start; gap: 0.75rem;">
                                        <span style="width: 0.375rem; height: 0.375rem; border-radius: 50%; background-color: hsl(var(--accent)); margin-top: 0.5rem; flex-shrink: 0;"></span>
                                        <span style="color: hsl(var(--foreground) / 0.7); font-size: 0.875rem;">{{ $point }}</span>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
...
<section id="video-section" style="padding: 7rem 0; position: relative; overflow: hidden; background-size: cover; background-position: center; background-repeat: no-repeat; background-image: url('{{ asset('assets/section-6-bg.png') }}')">
    <div class="container" style="position: relative;">
        <div style="max-width: 80rem; margin: 0 auto;">
